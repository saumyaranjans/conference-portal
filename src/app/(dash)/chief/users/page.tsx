...
export default async function ConvenerUsersPage() {
  // Not requireRole: role management is the Convener's alone, and an Editorial
  // Office account that could edit roles could promote itself to Convener.
  ...
  return (
    <>
      <PageHeader
        title="Users & Roles"
        subtitle="Grant Reviewer, Track Editor, Convener or Editorial Office rights. Everyone is an author by default."
      />
      ...
      <div className="space-y-3">
        {users.map((u) => (
          <div key={u.id} className="card card-pad">
            ...
            {/* Convener access tier — set by a Convener, for a Convener. */}
