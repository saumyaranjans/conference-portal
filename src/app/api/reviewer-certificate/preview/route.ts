...
import { buildReviewerCertificatePreview } from "@/lib/certificateBuilders";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

/** Staff-only, on-the-fly preview of a reviewer certificate (nothing stored). */
export async function GET(request: Request) {
  ...
  const res = await buildReviewerCertificatePreview(admin, email);
