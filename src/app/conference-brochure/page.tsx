...
export default function ConferenceBrochurePage() {
  return (
    <ConferenceDocumentPage
      ...
      pdf="/downloads/glogift-2027-conference-brochure.pdf?v=glogift27-20260810-revised-fees"
      pages={[
        "/document-previews/brochure/page-1.png?v=glogift27-20260810-revised-fees",
        "/document-previews/brochure/page-2.png?v=glogift27-20260810-revised-fees",
        "/document-previews/brochure/page-3.png?v=glogift27-20260810-revised-fees",
      ]}
    />
  );
}
