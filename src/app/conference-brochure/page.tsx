...
export const metadata: Metadata = {
  ...
  description: "View and download the three-page GLOGIFT 2027 conference brochure.",
};
...
export default function ConferenceBrochurePage() {
  return (
    <ConferenceDocumentPage
      ...
      description="Read the three-page GLOGIFT 2027 conference brochure online, or download the original PDF below."
