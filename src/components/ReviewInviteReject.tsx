...
import { rejectReviewAssignment } from "@/lib/actions";

/**
 * Landing page for the Decline link in a reviewer invitation email (existing
 * reviewer). Captures a brief reason, marks the assignment declined, notifies
 * the Track Editor, and thanks the reviewer.
 */
export function ReviewInviteReject({
  token,
  valid,
  paperId,
  title,
